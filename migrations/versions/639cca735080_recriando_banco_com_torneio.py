"""recriando banco com torneio

Revision ID: 639cca735080
Revises: 
Create Date: 2026-02-18 14:31:46.042344
...
def upgrade():
    ...
    sa.Column('belongs_only_to_contest', sa.Boolean(), nullable=False),
